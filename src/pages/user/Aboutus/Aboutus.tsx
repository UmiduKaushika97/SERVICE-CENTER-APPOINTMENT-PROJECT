...
const services = [
  { title: "Car Wash & Detailing", img: CarWash },
  { title: "Body Shop & Painting", img: Paint },
  { title: "Workshop & Repairs", img: WorkShop },
  { title: "Inspection Reports & Pre-Purchase Advice", img: Inspection },
  { title: "Accident Repairs", img: Accident },
  { title: "Routine Maintenance", img: Routine },
];
...
<section className="bg-white py-16 px-6">
  ...
  <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    {services.map((service, idx) => (
      <div
        key={idx}
        className="relative h-60 rounded-lg shadow overflow-hidden cursor-pointer group"
      ...
      >
        ...
        <div
  className="absolute inset-0 group hover:bg-opacity-30 flex items-center justify-center transition duration-300 group-hover:backdrop-blur-sm group-hover:bg-opacity-50"
>
  <h3 className="text-white group-hover:text-red-800 group-hover:text-2xl transition-all duration-150 ease-in text-xl font-bold text-center px-4">
    {service.title}
  </h3>
</div>
    ...
    <section className="py-16 px-6 max-w-5xl mx-auto">
      <h2 className="text-3xl font-semibold text-gray-800 text-center">Our Specialized Divisions</h2>
      <div className="mt-12 space-y-12">
        {/* Premier */}
        <div className="md:flex md:items-center">
          <div className="md:w-1/3">
            <h3 className="text-2xl font-semibold text-black">Care Point Premier</h3>
          </div>
          <div className="md:w-2/3 mt-4 md:mt-0 text-gray-700">
            Located in the heart of Colombo, Care Point Premier caters to VIP vehicle servicing with premium care
            and convenience. 
        ...
        <div className="md:flex md:items-center">
          <div className="md:w-1/3">
            <h3 className="text-2xl font-semibold text-black">Care Point Ramdis</h3>
          </div>
          <div className="md:w-2/3 mt-4 md:mt-0 text-gray-700">
        ...
        <div className="md:flex md:items-center">
          <div className="md:w-1/3">
            <h3 className="text-2xl font-semibold text-black">Care Point VROOM</h3>
          </div>
          <div className="md:w-2/3 mt-4 md:mt-0 text-gray-700">
